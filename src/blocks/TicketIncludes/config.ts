...
export const TicketIncludes: Block = {
  ...
  fields: [
    { name: "title", type: "text", required: true, label: "Heading", defaultValue: "What Your Ticket Includes" },
    {
      name: "items",
      type: "array",
      label: "Inclusions",
      ...
      defaultValue: [
        ...
        { subtitle: "VIP & Club Access:", text: "Includes VIP lounge, private restrooms, and fast-track entry" },
