...
export const ScheduleSplit: Block = {
  ...
  fields: [
    { name: "title", type: "text", required: true, label: "Heading", defaultValue: "Friday, March 21" },
    ...
    { name: "reverseLayout", type: "checkbox", label: "Image on right (reverse layout)", defaultValue: false },
