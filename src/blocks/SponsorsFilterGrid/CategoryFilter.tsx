...
function DesktopTabs({
  ...
  return (
    <div
      ...
      className={[
        'relative flex w-full items-center justify-center gap-10 overflow-x-auto pb-3',
        className ?? '',
      ].join(' ')}
    >
      {categories.map((c, i) => {
        ...
        return (
          <button
            ...
            className={[
              'font-ivar relative pb-2 text-lg lg:text-5xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8B9B5C]/40 focus-visible:rounded',
            ...
            return (
              <div key={c.id} className="shrink-0">
                <button
                  ...
                  onClick={() => onChange(c.id)}
                  className={[
                    'font-ivar relative pb-2 text-3xl transition-colors mx-2',
                    isActive ? 'text-black' : 'text-gray-400 hover:text-black',
                  ].join(' ')}
                >
                  {c.name}
